                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3">
                            ...
                            <form action="#" method="POST" className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                                ...
                                <div className="mt-1">
                                    ...
                                    className="block w-full rounded-md border-warm-white-300 py-3 px-4 text-white shadow-sm focus:border-teal-500 focus:ring-teal-500"
                                    />
                                </div>
                                </div>
                                <div>
                                ...
                                <div className="sm:col-span-2">
                                    ...
                                    <div className="mt-1">
                                        ...
                                        name="message"
                                        rows={4}
                                        className="block w-full rounded-md border-warm-white-300 py-3 px-4 text-white-900 shadow-sm focus:border-teal-500 focus:ring-teal-500"
